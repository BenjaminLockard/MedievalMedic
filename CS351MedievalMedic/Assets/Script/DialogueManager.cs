...
public class DialogueManager : MonoBehaviour
{
    ...
    private string[,] allStories = {
        ...
        {"They nailed me with a trebuchet, just my luck… crushed my leg flat, I can’t even move it anymore.", "I tried feeding a stray dog, didn’t go well. That mutt mauled my hand so badly I’m surprised it’s still attached…", "I was kicked off a cliff yesterday, landed on my now shattered legs. It took two men just to drag me in here."},
        ...
        {"That last battle was hectic, left me with too many bruises and wounds to count. None too deep, thankfully, I just need them covered.", "Had to train with a drunk guy, thought it’d be fine to use a real weapon. He was awful, but still gave me some shallow cuts.", "Somebody startled me while I sifting through the armory, led to me getting this cut on my hand."},
